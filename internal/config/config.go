...
var (
	...
	ConversationHTTPAddr   = getenv("CONVERSATION_HTTP_ADDR", ":9003")
	ConversationGRPCAddr   = getenv("CONVERSATION_GRPC_ADDR", ":9013")
	GroupHTTPAddr          = getenv("GROUP_HTTP_ADDR", ":9004")
	GroupGRPCAddr          = getenv("GROUP_GRPC_ADDR", ":9014")
	GroupServiceGRPCTarget = getenv("GROUP_SERVICE_GRPC_TARGET", "localhost:9014")
